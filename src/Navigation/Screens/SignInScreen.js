...
const SignInScreen = ({navigation}) => {
    ...
    const loginHandle = (userName, password) => {
        ...
        fetch('http://www.haven2u.com/Dependency/index.php', {
          method: 'POST',
          headers: {
          ...
          body: 
            ...
            .then( async (jsonData) => {
                      ...
                      // Showing response message coming from server after inserting records.
                        console.warn("getLoginCheck: "+jsonData);
                        var allData = JSON.parse(jsonData);


                        if(allData.code == 1){
                          var name = allData.result;
                          signIn(allData);
    ...
    return (
      <View style={styles.container}>
        ...
        >
            ...
            <TouchableOpacity>
                <Text style={{color: '#97B1A6', marginTop:15}}>Forgot password?</Text>
            </TouchableOpacity>
